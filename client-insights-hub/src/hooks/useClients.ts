...
export function useClients() {
  ...
  const syncToSheets = async (client: Client) => {
    try {
      ...
      await fetch("https://script.google.com/macros/s/AKfycbwJEJSf2XxGpLLqK6UJVChYyr9b8c0JwmvrRfk_1KY0ev5AsYnJoiEN6An_cl02c7_o7g/exec", {
        method: "POST",
        mode: "no-cors", 
  ...
  const pullFromSheets = async (): Promise<boolean> => {
    try {
      ...
      const response = await fetch("https://script.google.com/macros/s/AKfycbwJEJSf2XxGpLLqK6UJVChYyr9b8c0JwmvrRfk_1KY0ev5AsYnJoiEN6An_cl02c7_o7g/exec");
